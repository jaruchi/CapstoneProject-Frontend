...
@Component({
  selector: 'app-garden-care-requirement',
  templateUrl: './garden-care-requirement.component.html',
  styleUrls: ['./garden-care-requirement.component.scss']
})
export class GardenCareRequirementComponent implements OnInit {
